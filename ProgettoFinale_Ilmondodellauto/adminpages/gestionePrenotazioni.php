...
if (isset($_POST['cambio_stato'])) {
    ...
    header("Location: gestionePrenotazioni.php?successo=1"); exit;
}

$stmt = $db->query("SELECT p.*, u.Nome, u.Cognome, m.Marca, m.Modello 
    FROM prenotazione p 
...
<div class="container mt-4">
    ...
    <?php if (isset($_GET['successo'])) echo "<div class='alert-successo'>Stato aggiornato.</div>"; ?>
